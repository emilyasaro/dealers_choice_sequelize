...
const syncAndSeed = async () => {
  try {
    ...
    const dojos = await Promise.all([
      Dojo.create({ name: "Miyagi-Do Karate", grandMaster: "Nariyoshi Miyagi", motto: "When the fight comes to you, you have to be ready to fight back." }),
      Dojo.create({ name: "Cobra Kai Karate", grandMaster: "John Kreese", motto: "Strike first. String hard. No Mercy."}),
